...
namespace Repository
{
    public static class DBInitializer
    {
        public static void Initialize(eTeatarContext context)
        {
            ...
            KorisnickiNalog Korisnik1 = new KorisnickiNalog { KorisnickoIme = "Kupac", Email = "Kupac@Email.com", LozinkaHash = "j7+6UDUsnJcVogyMj2kZsLhfrgY=", LozinkaSalt = "yHXtkSuamKxmhzbWfbDKIg==", Adresa = "Adresa 11", DatumKreiranja = DateTime.Now, Grad = Grad1, Ime = "KupacIme", Prezime = "KupacPrezime", KorisnickaUloga = KorisnickaUloga2 };
            KorisnickiNalog Korisnik2 = new KorisnickiNalog { KorisnickoIme = "Kupac2", Email = "Kupac2@Email.com", LozinkaHash = "j7+6UDUsnJcVogyMj2kZsLhfrgY=", LozinkaSalt = "yHXtkSuamKxmhzbWfbDKIg==", Adresa = "Adresa 11", DatumKreiranja = DateTime.Now, Grad = Grad1, Ime = "KupacIme2", Prezime = "KupacPrezime2", KorisnickaUloga = KorisnickaUloga2 };
            KorisnickiNalog Korisnik3 = new KorisnickiNalog { KorisnickoIme = "Kupac3", Email = "Kupac3@Email.com", LozinkaHash = "j7+6UDUsnJcVogyMj2kZsLhfrgY=", LozinkaSalt = "yHXtkSuamKxmhzbWfbDKIg==", Adresa = "Adresa 11", DatumKreiranja = DateTime.Now, Grad = Grad1, Ime = "KupacIme3", Prezime = "KupacPrezime3", KorisnickaUloga = KorisnickaUloga2 };
            KorisnickiNalog Korisnik4 = new KorisnickiNalog { KorisnickoIme = "Kupac4", Email = "Kupac4@Email.com", LozinkaHash = "j7+6UDUsnJcVogyMj2kZsLhfrgY=", LozinkaSalt = "yHXtkSuamKxmhzbWfbDKIg==", Adresa = "Adresa 11", DatumKreiranja = DateTime.Now, Grad = Grad1, Ime = "KupacIme4", Prezime = "KupacPrezime4", KorisnickaUloga = KorisnickaUloga2 };
            KorisnickiNalog Korisnik5 = new KorisnickiNalog { KorisnickoIme = "Admin", Email = "Admin@Email.com", LozinkaHash = "j7+6UDUsnJcVogyMj2kZsLhfrgY=", LozinkaSalt = "yHXtkSuamKxmhzbWfbDKIg==", Adresa = "Adresa 11", DatumKreiranja = DateTime.Now, Grad = Grad1, Ime = "AdminIme", Prezime = "AdminPrezime", KorisnickaUloga = KorisnickaUloga1 };
            KorisnickiNalog Korisnik6 = new KorisnickiNalog { KorisnickoIme = "Admin2", Email = "Admin2@Email.com", LozinkaHash = "j7+6UDUsnJcVogyMj2kZsLhfrgY=", LozinkaSalt = "yHXtkSuamKxmhzbWfbDKIg==", Adresa = "Adresa 11", DatumKreiranja = DateTime.Now, Grad = Grad1, Ime = "AdminIme2", Prezime = "AdminPrezime2", KorisnickaUloga = KorisnickaUloga1 };
            KorisnickiNalog KorisnikAdi = new KorisnickiNalog { KorisnickoIme = "Adi", Email = "adi.sose@outlook.com", LozinkaHash = "j7+6UDUsnJcVogyMj2kZsLhfrgY=", LozinkaSalt = "yHXtkSuamKxmhzbWfbDKIg==", Adresa = "Grbavicka 50", DatumKreiranja = DateTime.Now, Grad = Grad1, Ime = "Adi", Prezime = "Sose", KorisnickaUloga = KorisnickaUloga2 };
            KorisnickiNalog KorisnikAdnan = new KorisnickiNalog { KorisnickoIme = "Adnan", Email = "adnan.cutura@outlook.com", LozinkaHash = "j7+6UDUsnJcVogyMj2kZsLhfrgY=", LozinkaSalt = "yHXtkSuamKxmhzbWfbDKIg==", Adresa = "Adresa 50", DatumKreiranja = DateTime.Now, Grad = Grad1, Ime = "Adnan", Prezime = "Cutura", KorisnickaUloga = KorisnickaUloga2 };
